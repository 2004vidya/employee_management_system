...
const CompleteTask = ({ data }) => {
  return (
    <div className="mt-20 block  w-[25%] p-6 bg-green-400 border border-gray-200 rounded-lg shadow hover:bg-green-200 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
